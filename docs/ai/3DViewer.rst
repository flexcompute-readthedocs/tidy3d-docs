...
The 3D Viewer is an interactive visualization tool that provides real-time, three-dimensional rendering of Tidy3D simulations directly within your code editor. Integrated seamlessly into the Tidy3D extensions for `Cursor <CursorExtension.html>`_ and `VS Code <VSCodeExtension.html>`_, the viewer automatically detects simulation objects in your Python scripts and notebooks, opening alongside your code to provide immediate visual feedback as you develop.
...
- **AI-Controlled** – `FlexAgent MCP <FlexAgent.html>`_ can navigate and explain the 3D scene through natural language
...
The 3D Viewer is automatically available when you install the Tidy3D extension for `Cursor <CursorExtension.html>`_ or `VS Code <VSCodeExtension.html>`_. No additional setup is required.
...
The 3D Viewer is part of the comprehensive Tidy3D + AI ecosystem. For more information, see the `Tidy3D + AI overview <Tidy3DPlusAI.html>`_.
