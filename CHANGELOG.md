...
- `tidy3d/converter.py` for conversion from .lsf project files into Tidy3D files through command line, e.g. `python -m tidy3d convert example.lsf tidy3d_script.py` or `tidy3d convert example.lsf tidy3d_script.py`
