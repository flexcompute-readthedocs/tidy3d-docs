...
### Breaking Changes
- Native web and batch support of `ModalComponentModeler` and `TerminalComponentModeler` required changing these classes schemas considerably. Equivalent behaviour is available using a different workflow.
